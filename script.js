...
function startQuiz() {
    ...
    document.getElementById('progress-container').style.display = 'block'; // Mostrar barra de progreso
    updateProgress(); // Actualizar progreso inicial
    showQuestion();
}
...
function updateProgress() {
    ...
    // Actualizar el texto de progreso fuera de la barra pero dentro del contenedor
